...
const requestBody = require('../../data/API_JSON/svc_console_report.json');

test('API_svcConsole_Report_Test: Fetch Reports API', async ({ page }) => {
  let accessToken = '';
  ...
  console.log('Request URL:', apiEndpoints.report);
  ...
  const apiUrl = apiEndpoints.report;
