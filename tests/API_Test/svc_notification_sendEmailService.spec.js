...
const requestBody = require('../../data/API_JSON/svc_notification_sendEmailService.json');

test('API_svcNotification_SendEmailService_Test: Send Email Notification Service API', async ({ page }) => {
  let accessToken = '';
  ...
  console.log('Request URL:', apiEndpoints.sendEmailService);
  ...
  const apiUrl = apiEndpoints.sendEmailService;
