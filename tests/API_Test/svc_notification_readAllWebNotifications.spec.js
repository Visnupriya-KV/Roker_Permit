...
test('API_svcNotification_ReadAllWebNotifications_Test: Mark All Web Notifications as Read API', async ({ page }) => {
  let accessToken = '';
  ...
  const apiUrl = apiEndpoints.readAllWebNotifications;
