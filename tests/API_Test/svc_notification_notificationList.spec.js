...
test('API_svcNotification_NotificationList_Test: Fetch Notification Preference List API', async ({ page }) => {
  let accessToken = '';
  ...
  console.log('Request URL:', apiEndpoints.notificationList);
  ...
  const apiUrl = apiEndpoints.notificationList;
