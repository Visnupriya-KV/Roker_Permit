...
const requestBody = require('../../data/API_JSON/svc_notification_emailServiceList.json');

test('API_svcNotification_EmailServiceList_Test: Fetch Email Service List API', async ({ page }) => {
  let accessToken = '';
  ...
  console.log('Request URL:', apiEndpoints.emailServiceList);
  ...
  const apiUrl = apiEndpoints.emailServiceList;
