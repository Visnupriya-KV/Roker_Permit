...
test('API_svcNotification_EmailServiceStatusById_Test: Fetch Email Service Status by ID API', async ({ page }) => {
  let accessToken = '';
  ...
  const emailServiceId = 1; // Replace with the actual ID
  const apiUrl = `${apiEndpoints.emailServiceStatusById}/${emailServiceId}`;
