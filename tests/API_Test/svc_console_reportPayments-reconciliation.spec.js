...
const requestBody = require('../../data/API_JSON/svc_console_reportPayments-reconciliation.json');

test('API_svcConsole_ReportPaymentsReconciliation_Test: Payments Reconciliation Report API', async ({ page }) => {
  let accessToken = '';
  ...
  console.log('Request URL:', apiEndpoints.reportPaymentsReconciliation);
  ...
  const apiUrl = apiEndpoints.reportPaymentsReconciliation;
