...
test('API_svcConsole_EmailNotificationTemplatesGetById_Test: Get Email Notification Template by ID API', async ({ page }) => {
  let accessToken = '';
  ...
  const templateId = 2; // Replace with the actual template ID
  const apiUrl = `${apiEndpoints.emailNotificationTemplateById}/${templateId}/detail`;
