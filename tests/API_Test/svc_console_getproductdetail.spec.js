...
test('API_svcConsole_GetProductDetail_Test: Get Product Detail API', async ({ page }) => {
  let accessToken = '';
  ...
  console.log('Request URL:', apiEndpoints.getProductDetail);
  ...
  const apiUrl = apiEndpoints.getProductDetail;
