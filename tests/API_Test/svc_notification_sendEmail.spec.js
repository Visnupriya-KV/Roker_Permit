...
const requestBody = require('../../data/API_JSON/svc_notification_sendEmail.json');

test('API_svcNotification_SendEmail_Test: Send Email Notification API', async ({ page }) => {
  let accessToken = '';
  ...
  console.log('Request URL:', apiEndpoints.sendEmailNotification);
  ...
  const apiUrl = apiEndpoints.sendEmailNotification;
