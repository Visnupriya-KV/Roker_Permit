...
const requestBody = require('../../data/API_JSON/svc_notification_updatenotificationsetting.json');

test('API_svcNotification_UpdateNotificationSetting_Test: Update Notification Setting API', async ({ page }) => {
  let accessToken = '';
  ...
  console.log('Request URL:', apiEndpoints.updateNotificationSetting);
  ...
  const apiUrl = apiEndpoints.updateNotificationSetting;
